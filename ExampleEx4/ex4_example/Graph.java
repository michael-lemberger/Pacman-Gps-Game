...
public class Graph
{
  ...
  public Graph() { _nodes = new ArrayList(); }
  ...
  public int size() { return _nodes.size(); }
  ...
  public void toFile() { long t = new Date().getTime();
  ...
  public void clear_meta_data() { for (int i = 0; i < size(); i++)
  ...
  public boolean exist(Node d) { return getNodeByName(d.get_name()) != null; }
  ...
  public Node getNodeByName(String s) { Node ans = null;
  ...
  public void addEdge(String a, String b, double w) { Node va = getNodeByName(a);
